 ...
 *
 * User_new will use the reference to UserPermissions that it is given rather
 * than make a defensive copy
...
User_T User_new_default() { return User_new(-1, NULL, NULL); }
